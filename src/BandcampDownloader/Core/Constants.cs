...
namespace BandcampDownloader
{
    internal static class Constants
    {
        ...
        /// </summary>
        public static readonly string UrlChangelog = "https://raw.githubusercontent.com/Flarky55/BandcampDownloader/master/CHANGELOG.md";
        /// <summary>
        /// The URL redirecting to the help page on translating the app on GitHub.
        /// </summary>
        public static readonly string UrlHelpTranslate = "https://github.com/Flarky55/BandcampDownloader/blob/master/docs/help-translate.md";
        /// <summary>
        /// The URL redirecting to the issues page on GitHub.
        /// </summary>
        public static readonly string UrlIssues = "https://github.com/Flarky55/BandcampDownloader/issues";
        /// <summary>
        /// The URL redirecting to the latest release on GitHub.
        /// </summary>
        public static readonly string UrlLatestRelease = "https://github.com/Flarky55/BandcampDownloader/releases/latest";
        /// <summary>
        /// The URL redirecting to the releases page on GitHub.
        /// </summary>
        public static readonly string UrlReleases = "https://github.com/Flarky55/BandcampDownloader/releases";
        /// <summary>
        /// The URL redirecting to the zip file. Must be formatted with a version.
        /// </summary>
        public static readonly string UrlReleaseZip = "https://github.com/Flarky55/BandcampDownloader/releases/download/v{0}/BandcampDownloader.zip";
        /// <summary>
        /// The website URL of BandcampDownloader.
        /// </summary>
        public static readonly string UrlWebsite = "https://github.com/Flarky55/BandcampDownloader";
        /// <summary>
